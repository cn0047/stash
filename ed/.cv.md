...
|---------------------------|-----------------------------------------------------------------|
| algolia                   | add document; update; partialUpdate; search; |
...
| domain-driven-design      | implement in php; |
...
| go                        | struct; panic; regexp; templates; net/http; archive/zip; testing; coverage; benchmark; pprof; godepgraph; channel; goroutine; ftp; interface; websocket; reflect; |
| google                    | chart; |
...
| kubernetes                | pod; replicationController; service (loadBalancer); |
...
| nginx *[dev]*             | https; |
| node.js                   | fs; promise; es6; promisify; events; streams; socket.io; node-fetch; tests (assert, jest, mocha, chai, sinon, nock); |
| node.js *[dev]*           | mongodb; mongoose; mailer; i18n; mysql; nodemon; loopback; |
| npm                       | publish; |
...
| postgresql                | insert; select; dump; REPL; explain; join; union; json; array; view; full-text search; |
...
* **groovy**     since 2017 - Used for queries into elasticsearch.
