...
| bash                      | for; grep; ps aux; find; array; function; if-else; case; wait; |
...
| google-app-enginee        | deploy go app; datastore; search; cron; push queue; memcache; cloud-sql (postgresql); upgrade go1 → go111; |
| google-container-registry | push image; pull image; |
| google-datastore          | put; query; |
