...
func main() {
	//f1()
	//structPointerToInterface()
	//fromJSONStrToInterface()
	//fromJSONStrToSturct()
	//fromInterfaceJSONStrToSturct()
	fromSpecificInterfaceJSONStrToSturct()
}
...
func fromInterfaceJSONStrToSturct() {
	f1 := Foo{Foo: "f5"}
	var if1 interface{}
	if1 = &f1
...
func fromSpecificInterfaceJSONStrToSturct() {
	f1 := Foo{Foo: "f6"}
	var v1 Valuable
	v1 = &f1
